document.addEventListener('DOMContentLoaded', () => {
    ...
    if (timetable) {
        ...
        function submitTimetableForm(form, successCallback, errorCallback) {
        ...
        document.getElementById('timetableForm').addEventListener('submit', function (e) {
            e.preventDefault();
            submitTimetableForm(this);
        });

        // event listener for submit_timetable anchor
        const submitTimetable = document.getElementById('submit_timetable');
        submitTimetable.addEventListener('click', function(e) {
            e.preventDefault();
